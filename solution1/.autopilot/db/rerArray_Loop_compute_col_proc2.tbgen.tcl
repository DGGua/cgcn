...
set C_modelArgList {
	...
	{ output_r int 32 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "output_size", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "output_r", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ output_r_din sc_out sc_lv 32 signal 1 } 
	...
	{ property_input_dout sc_in sc_lv 32 signal 3 } 
	{ property_input_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ property_input_fifo_cap sc_in sc_lv 2 signal 3 } 
	{ property_input_empty_n sc_in sc_logic 1 signal 3 } 
	{ property_input_read sc_out sc_logic 1 signal 3 } 
	{ weight_input_dout sc_in sc_lv 32 signal 4 } 
	{ weight_input_num_data_valid sc_in sc_lv 2 signal 4 } 
	{ weight_input_fifo_cap sc_in sc_lv 2 signal 4 } 
	{ weight_input_empty_n sc_in sc_logic 1 signal 4 } 
	{ weight_input_read sc_out sc_logic 1 signal 4 } 
	{ featrue_length_c_din sc_out sc_lv 32 signal 5 } 
	{ featrue_length_c_num_data_valid sc_in sc_lv 2 signal 5 } 
	{ featrue_length_c_fifo_cap sc_in sc_lv 2 signal 5 } 
	{ featrue_length_c_full_n sc_in sc_logic 1 signal 5 } 
	{ featrue_length_c_write sc_out sc_logic 1 signal 5 } 
	{ output_size_c_din sc_out sc_lv 32 signal 6 } 
	{ output_size_c_num_data_valid sc_in sc_lv 2 signal 6 } 
	{ output_size_c_fifo_cap sc_in sc_lv 2 signal 6 } 
	{ output_size_c_full_n sc_in sc_logic 1 signal 6 } 
	{ output_size_c_write sc_out sc_logic 1 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_r_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "output_r", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "property_input", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_rerArray_Loop_compute_col_proc2_Pipeline_PE_Compute_fu_105", "Port" : "property_input", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "weight_input", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_rerArray_Loop_compute_col_proc2_Pipeline_PE_Compute_fu_105", "Port" : "weight_input", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_rerArray_Loop_compute_col_proc2_Pipeline_PE_Compute_fu_105", "Parent" : "0", "Child" : ["2", "3"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_rerArray_Loop_compute_col_proc2_Pipeline_PE_Compute_fu_105.mul_32s_32s_32_1_1_U7", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_rerArray_Loop_compute_col_proc2_Pipeline_PE_Compute_fu_105.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	output_r { ap_fifo {  { output_r_din fifo_port_we 1 32 }  { output_r_num_data_valid fifo_status_num_data_valid 0 2 }  { output_r_fifo_cap fifo_update 0 2 }  { output_r_full_n fifo_status 0 1 }  { output_r_write fifo_data 1 1 } } }
