...
HLS_SOURCES = ../../../testbench.cpp ../../../systolic.cpp ../../../test.cpp
...
$(ObjDir)/systolic.o: ../../../systolic.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../systolic.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/systolic.d
...
$(pObjDir)/systolic.bc: ../../../systolic.cpp $(pObjDir)/.dir
...
profile_all: profile_data $(POBJECTS)
	...
	${MKDIR} /home/ubuntu/VitisCodes/test2/solution2/.autopilot/db/dot ; \
	${CP} -r ${pObjDir} /home/ubuntu/VitisCodes/test2/solution2/.autopilot/db/dot ; \
	${CP} LinkFile.bc /home/ubuntu/VitisCodes/test2/solution2/.autopilot/db/dot ; \
	${CD} /home/ubuntu/VitisCodes/test2/solution2/.autopilot/db/dot ; \
	${AP_CLANG_PATH}/opt -dot-callgraph-hls -cfg-hier-userfilelist "/home/ubuntu/VitisCodes/test2/testbench.cpp /home/ubuntu/VitisCodes/test2/systolic.cpp /home/ubuntu/VitisCodes/test2/test.cpp" -csim-top-function-name=vector_add LinkFile.bc -o LinkFile_fid.bc ; \
	${AP_CLANG_PATH}/opt -dot-cfg-hier-only -cfg-hier-userfilelist "/home/ubuntu/VitisCodes/test2/testbench.cpp /home/ubuntu/VitisCodes/test2/systolic.cpp /home/ubuntu/VitisCodes/test2/test.cpp" -cfg-hier-type csim LinkFile_fid.bc -o LinkFile_pp.bc ; 
