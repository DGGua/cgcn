...
# 2 "<built-in>" 2
# 1 "test2/systolic.cpp" 2
# 1 "test2/systolic.h" 1
...
PE_Compute:
    ...
    {
#line 13 "/home/ubuntu/VitisCodes/test2/solution2/directives.tcl"
#pragma HLSDIRECTIVE LOOP_TRIPCOUNT max=32
# 10 "test2/systolic.cpp"

#line 15 "/home/ubuntu/VitisCodes/test2/solution2/directives.tcl"
#pragma HLSDIRECTIVE UNROLL factor=1
# 10 "test2/systolic.cpp"
...
void rerArray(int *featrue_data, int featrue_length, int *weight_array, int output_size, int node_cnt, int *output_data)
{
#line 12 "/home/ubuntu/VitisCodes/test2/solution2/directives.tcl"
#pragma HLSDIRECTIVE DATAFLOW
# 19 "test2/systolic.cpp"

    hls::stream<int> property_input[4][32];
#line 17 "/home/ubuntu/VitisCodes/test2/solution2/directives.tcl"
#pragma HLSDIRECTIVE ARRAY_PARTITION variable=property_input complete dim=1
# 20 "test2/systolic.cpp"

    hls::stream<int> weight_input[4][32];
#line 18 "/home/ubuntu/VitisCodes/test2/solution2/directives.tcl"
#pragma HLSDIRECTIVE ARRAY_PARTITION variable=weight_input complete dim=2
# 21 "test2/systolic.cpp"

    hls::stream<int> output[4][32];
#line 19 "/home/ubuntu/VitisCodes/test2/solution2/directives.tcl"
#pragma HLSDIRECTIVE ARRAY_PARTITION variable=output complete dim=2
# 22 "test2/systolic.cpp"

    int batchnum = node_cnt / 4;
    int buff[4][32];
#line 20 "/home/ubuntu/VitisCodes/test2/solution2/directives.tcl"
#pragma HLSDIRECTIVE ARRAY_PARTITION variable=buff complete dim=2
# 24 "test2/systolic.cpp"

compute_col:
    for (int col = 0; col < output_size; col++)
    {
#line 16 "/home/ubuntu/VitisCodes/test2/solution2/directives.tcl"
#pragma HLSDIRECTIVE LOOP_TRIPCOUNT max=32
# 27 "test2/systolic.cpp"

    compute_row:
        for (int row = 0; row < 4; row++)
        {
#line 14 "/home/ubuntu/VitisCodes/test2/solution2/directives.tcl"
#pragma HLSDIRECTIVE UNROLL
# 30 "test2/systolic.cpp"

            PE(property_input[row][col], weight_input[row][col], output[row][col], featrue_length);
        }
    }
input_batch:
    ...
    input_turn_property:
        ...
        input_property:
            for (int row = 0; row < 4; row++)
            {
                int featrue_val = featrue_data[(batch * 4 + row) * featrue_length + turn];
                VITIS_LOOP_44_1: for (int col = 0; col < output_size; col++)
                {
        ...
        input_weight:
            for (int col = 0; col < output_size; col++)
            {
                ...
                VITIS_LOOP_58_2: for (int row = 0; row < 4; row++)
                {
                    weight_input[row][col].write(weight_val);
                }
            }
            }
        VITIS_LOOP_64_3: for (int col = 0; col < output_size; col++)
        {
            VITIS_LOOP_66_4: for (int row = 0; row < 4; row++)
            {
                buff[row][col] = output[row][col].read();
            }
        }
        VITIS_LOOP_71_5: for (int row = 0; row < 4; row++)
        {
            memcpy(output_data + (batch * 4 + row) * output_size, buff[row], output_size * sizeof(int));
        }
    }
}
